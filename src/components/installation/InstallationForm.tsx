...
import { Building2, FileSignature, FileText, Package, Users, Plus, Trash2, Download, Loader2 } from "lucide-react";
...
export function InstallationForm({
  ...
  const baseHardwareLineItems = (() => {
    if (quoteLineItems && quoteLineItems.length > 0) {
      ...
      // If no items are explicitly typed as hardware, treat ALL non-service items
      // as installable. This handles products from HubSpot with no hs_product_type
      // set, while keeping service lines (Delivery, Removal, etc.) off the doc.
      if (hwItems.length === 0) {
    ...
    <div className="space-y-6">
      ...
      {formData.selectedLineItemId && (
        <>
          ...
          {/* Customer addresses - two cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            <SectionCard title="Ship To" icon={Building2}>
            ...
            <SectionCard title="Bill To" icon={Building2}>
              <div className="space-y-3">
                <div>
                  <Label>Company</Label>
                  <Input
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <Select
                          value={formData.dealerSetupPrint}
                          onValueChange={(v) => updateField("dealerSetupPrint", v)}
                        >
                          <SelectTrigger className="h-8 text-sm">
                            <SelectValue placeholder="Select..." />
                          </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        value={formData.allowMobilePrint}
                        onValueChange={(v) => updateField("allowMobilePrint", v)}
                      >
                        <SelectTrigger className="h-8 text-sm">
                          <SelectValue placeholder="Select..." />
                        </SelectTrigger>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <Select
                          value={formData.dealerSetupScan}
                          onValueChange={(v) => updateField("dealerSetupScan", v)}
                        >
                          <SelectTrigger className="h-8 text-sm">
                            <SelectValue placeholder="Select..." />
                          </SelectTrigger>
            ...
            <div className="space-y-4">
              <SectionCard title="IT Contact" icon={Users}>
              ...
              <SectionCard title="Meter Contact" icon={Users}>
                <div className="space-y-2">
                  <Input
