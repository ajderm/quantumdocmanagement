    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label htmlFor="customerPrintedName">Printed Name</Label>
              <Input
                id="customerPrintedName"
                value={formData.customerPrintedName}
                onChange={(e) =>
                  updateField("customerPrintedName", e.target.value)
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField("customerTitle", e.target.value)}
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "w-full justify-start text-left font-normal",
                      !formData.customerSignatureDate && "text-muted-foreground"
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formData.customerSignatureDate
                      ? format(formData.customerSignatureDate, "MM/dd/yyyy")
                      : "Select date"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    mode="single"
                    selected={formData.customerSignatureDate || undefined}
                    onSelect={(date) =>
                      updateField("customerSignatureDate", date || null)
                    }
                    initialFocus
                    className="pointer-events-auto"
                  />
        ...
        {/* Dealer Signature */}
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-muted-foreground">Dealer</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="dealerRepresentative">Representative</Label>
              <Input
                id="dealerRepresentative"
                value={formData.dealerRepresentative}
                onChange={(e) =>
                  updateField("dealerRepresentative", e.target.value)
                }
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "w-full justify-start text-left font-normal",
                      !formData.dealerSignatureDate && "text-muted-foreground"
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formData.dealerSignatureDate
                      ? format(formData.dealerSignatureDate, "MM/dd/yyyy")
                      : "Select date"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    mode="single"
                    selected={formData.dealerSignatureDate || undefined}
                    onSelect={(date) =>
                      updateField("dealerSignatureDate", date || null)
                    }
                    initialFocus
                    className="pointer-events-auto"
                  />
