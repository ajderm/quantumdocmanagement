...
export function LoiForm({
  ...
  const createInitialFormData = (): LoiFormData => {
    ...
    const initialEquipment = equipmentFromLineItems.length > 0 ? equipmentFromLineItems : [{ model: "", serial: "" }];
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Equipment Being Returned */}
      <SectionCard title="Equipment Being Returned" icon={Package}>
        ...
        <div className="flex items-center space-x-2 pt-2 border-t">
          ...
          />
          <label htmlFor="hasAdditionalEquipment" className="text-sm cursor-pointer">
