  ...
  ({ formData, dealerInfo, termsAndConditions, documentStyles }, ref) => {
    ...
    return (
      <>
        ...
        className="bg-white p-6 min-h-[11in] w-[8.5in] text-[13px] leading-tight"
      ...
      >
        ...
        <div className="mb-2">
          <p className="font-bold text-[12px] border-b-2 border-black pb-1">INTERTERRITORIAL COORDINATOR INFORMATION</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-3">
          {/* Originating Dealer */}
          <div>
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">ORIGINATING DEALER</p>
          ...
          {/* Installing Dealer */}
          <div>
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">INSTALLING DEALER</p>
            <table className="w-full text-[12px]">
              <tbody>
          ...
          <div>
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">CUSTOMER INSTALLED TO</p>
            <table className="w-full text-[12px]">
              <tbody>
        ...
        <div className="mb-3">
          <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">EQUIPMENT TO BE INSTALLED</p>
          <table className="w-full text-[12px]">
            <thead>
        ...
        <div className="grid grid-cols-3 gap-4 mb-3">
          ...
          <div className="col-span-1">
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">SERVICE AGREEMENT</p>
            <table className="w-full text-[12px]">
              <tbody>
          ...
          <div className="col-span-2">
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">REMOVAL EQUIPMENT</p>
            {formData.removalEquipment.length === 0 ? (
              <p className="text-[12px] text-gray-500 text-center py-2">No removal equipment</p>
            ) : (
        ...
        {termsAndConditions && (
          <div className="mb-3">
            <p className="font-bold text-[12px] border-b-2 border-black pb-1 mb-1">ACCEPTANCE OF TERMS</p>
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-3">
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-[12px] font-bold">Installing Dealer:</span>
                  <div className="flex-1 border-b border-black h-5"></div>
                </div>
              </div>
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-[12px] font-bold">Printed Name:</span>
                  <div className="flex-1 border-b border-black h-5"></div>
                </div>
              </div>
              <div>
            ...
            <div className="space-y-3">
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-[12px] font-bold">Dealer Number:</span>
                  <div className="flex-1 border-b border-black h-5">
                    <span className="text-[12px]">{formData.installingDealerNumber || ''}</span>
                  </div>
                </div>
              </div>
              <div>
